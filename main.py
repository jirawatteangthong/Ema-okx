...
API_KEY = os.getenv(‘OKX_API_KEY’, ‘YOUR_OKX_API_KEY_HERE’)
SECRET = os.getenv(‘OKX_SECRET’, ‘YOUR_OKX_SECRET_HERE’)
PASSWORD = os.getenv(‘OKX_PASSWORD’, ‘YOUR_OKX_PASSWORD_HERE’)
...
try:
if not all([API_KEY, SECRET, PASSWORD]) or API_KEY == ‘YOUR_OKX_API_KEY_HERE’:
...
logger.warning(“⚠️ ไม่ได้ตั้งค่า Telegram Token”)
return
